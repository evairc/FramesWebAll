	...
	angular.module('primeiraApp').component('paginator', {
		...
		controller: [
			...
			function($location) {
				...
				this.needPagination = this.pages > 1 /*verifica se precisa ou mais de páginas (mais de 10)*/
				this.hasPrev = this.current > 1 /*não mostrar o botão anterior se tiver 1 página*/
				this.hasNext = this.current < this.pages /*não exibir mais se acabar*/
